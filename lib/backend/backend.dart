...
import 'schema/location_posts_record.dart';
...
export 'schema/location_posts_record.dart';
...
Stream<List<LocationPostsRecord>> queryLocationPostsRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(
        LocationPostsRecord.collection, LocationPostsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
